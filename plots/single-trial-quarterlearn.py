...
pylab.text(120, 1.03, r"No learning",fontsize=fsize,ha='center')
...
pylab.text(3.5,0.51,'E1',fontsize=fsize)
pylab.axvline(10,linestyle='--',linewidth=1,color='0.5')
pylab.text(13.5,0.51,'E2',fontsize=fsize)
pylab.axvline(20,linestyle='--',linewidth=1,color='0.5')
pylab.text(23.5,0.51,'E1',fontsize=fsize)
pylab.axvline(30,linestyle='--',linewidth=1,color='0.5')
pylab.text(33.5,0.51,'E2',fontsize=fsize)
pylab.axvline(40,linestyle='--',linewidth=1,color='0.5')
pylab.text(43.5,0.51,'E1',fontsize=fsize)
pylab.axvline(50,linestyle='--',linewidth=1,color='0.5')
pylab.text(53.5,0.51,'E2',fontsize=fsize)
pylab.axvline(60,linestyle='--',linewidth=1,color='0.5')
pylab.text(63.5,0.51,'E1',fontsize=fsize)
pylab.axvline(70,linestyle='--',linewidth=1,color='0.5')
pylab.text(73.5,0.51,'E2',fontsize=fsize)
pylab.axvline(80,linestyle='--',linewidth=1,color='0.5')
pylab.text(98,0.51,'E1',fontsize=fsize)
pylab.axvline(120,linestyle='--',linewidth=1,color='0.5')
pylab.text(138,0.51,'E2',fontsize=fsize)
...
pylab.xticks((20,40,60,80,120,160))

if save:
  pylab.savefig('../2011-BehaviourLearning-Fig12-Stop10.pdf')
  pylab.savefig('../2011-BehaviourLearning-Fig12-Stop10.png',dpi=600)
else:
  pylab.show()
