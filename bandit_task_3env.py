...
class BanditTask(nef.SimpleNode):
    def __init__(self,name,dims,trials_per_block=40,environments=[0,1,2,0,1,2],
                 block_rewards=[[0.21,0.21,0.63],[0.21,0.63,0.21],[0.63,0.21,0.21],
                                [0.12,0.12,0.72],[0.12,0.72,0.12],[0.72,0.12,0.12]]):
        # parameters
        self.dims = dims
